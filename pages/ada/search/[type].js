...
const SearchType = (props) => {
    ...
    return (
        <div>
            <SignedInHeader
                title={`Search / ${capitalizeFLetter(props.router.query.type)}`}
                searchBar={false}
            />
            <div
                style={{ height: "55%", paddingTop: "8%", textAlign: "center" }}
            >
                <div
                    style={{
                        width: "50%",
                ...
                >
                    <h2
                        ...
                        style={{ fontSize: 42, marginBottom: 20 }}
                    >
                        Search{" "}
                        {props.router.query.type
                            ? capitalizeFLetter(props.router.query.type)
                            : null}
                    </h2>
                    <div
                        style={{
                    ...
                    >
                        <Input
                            style={{
                                ...
                                alignItems: "center",
                                fontFamily: "auto",
                                border: "2px solid #f5eade !important",
                            }}
